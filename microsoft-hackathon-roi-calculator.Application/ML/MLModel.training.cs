...
namespace Microsoft_hackathon_roi_calculator_Application
{
    public partial class MLModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"ProjectBudget", @"ProjectBudget"),new InputOutputColumnPair(@"NumberOfEmployees", @"NumberOfEmployees"),new InputOutputColumnPair(@"ProjectDurationMonths", @"ProjectDurationMonths")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"ProjectBudget",@"NumberOfEmployees",@"ProjectDurationMonths"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"ROI",FeatureColumnName=@"Features"}));
